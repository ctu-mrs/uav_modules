...
WORKSPACE_NAME=modules_workspace
...
[ -e $MRS_WORKSPACE/install ] && EXTEND=install || EXTEND=devel
...
command catkin config --extend $MRS_WORKSPACE/$EXTEND
...
echo "$0: cloning uav_modules"
cd $GIT_PATH
[ ! -e uav_modules ] && git clone https://github.com/ctu-mrs/uav_modules
cd uav_modules
gitman install

echo "$0: linking uav_modules to $WORKSPACE_LOCATION/$WORKSPACE_NAME"
cd $WORKSPACE_PATH/src
ln -sf $GIT_PATH/uav_modules
